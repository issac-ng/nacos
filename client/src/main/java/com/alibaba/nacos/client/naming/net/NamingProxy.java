...
public class NamingProxy implements Closeable {
    ...
    private void initRefreshTask() {
        ...
        // TODO 验证是否是对的
        this.executorService.scheduleWithFixedDelay(new Runnable() {//每隔30秒 刷新 nacos server 列表 （主要用于集群下的寻址）
            @Override
            public void run() {
                refreshSrvIfNeed();
            }
        ...
        refreshSrvIfNeed();//刷新 nacos server 列表
        this.securityProxy.login(getServerList());//登录产生会话
    }
    ...
    public void deregisterService(String serviceName, Instance instance) throws NacosException {
         ...
         * 下一个入口：
         * com.alibaba.nacos.naming.controllers.InstanceController#deregister(javax.servlet.http.HttpServletRequest)
         */
    ...
    public String queryList(String serviceName, String clusters, int udpPort, boolean healthyOnly)
         ...
         *
         * 下一个入口: naming 模块
         *com.alibaba.nacos.naming.controllers.InstanceController#list(javax.servlet.http.HttpServletRequest)
         */
    ...
    /**
     * Request api.
     *  请求nacos server api 完成相关操作，这是一个通用方法
     * @param api     api               api路径
    ...
    public String reqApi(String api, Map<String, String> params, Map<String, String> body, List<String> servers,
        ...
        if (StringUtils.isNotBlank(nacosDomain)) {
            ...
            // nacos server 是集群的话，随机向某个节点发起请求，且轮询重试，重试最大次数为集群节点个数
